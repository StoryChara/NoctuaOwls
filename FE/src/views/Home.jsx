            ...
            <section className="about" id="nosotros">
                <div className="container">
                    <div className="stats-row">
                        <div className="stat-card"><FaTrophy className="stat-icon" /><strong className="stat-num">10</strong><span className="stat-label">Disciplinas</span></div>
                    ...
                    <div className="about-content">
                        ...
                        <p className="about-text">Contamos con equipos de alto rendimiento y divisiones de formación en <strong>10 disciplinas deportivas</strong>, reconocidas oficialmente en Colombia (Ley 026 de 2024) por su alta exigencia estratégica, técnica y mental.</p>
